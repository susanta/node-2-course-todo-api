...
describe('GET /todos/:id', () => {
    ...
    it('should retuen 404 non object ids', (done) => {
        request(app) 
            .get(`/todos/123`)
            .expect(404)
            .end(done);
...
describe('PATCH /todos/:id', () => {
    it('should update the to do', (done) => {
        ...
        request(app)
            ...
            .send({
                completed: true,
                text //ie. text: text on the left using es6
            })
            .expect(200)
            .expect((res) => {
...
describe('POST /users', () => {
    it('should create a user', (done) => {
        var email = 'inbox.susanta@gmail.com';
...
describe('DELETE /users/me/token', () => {
    it('shoild remove auth token on logout', (done) => {
        request(app)
